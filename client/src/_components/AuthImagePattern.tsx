        ...
        <div className='relative z-10 w-full max-w-md'>
          <div className='grid grid-cols-3 gap-4 mb-12'>
            {users.map((user, index) => (
              <div key={index} className='bg-gray-800/50 backdrop-blur-sm rounded-xl p-4 border border-gray-700/50 hover:bg-gray-700/50 transition-all animate-pulse duration-400 group'>
