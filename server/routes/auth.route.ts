...
import { updateProfile, uploadMiddleware } from "../controllers/updateProfile";
...
router.put("/update-profile", protectRoute, uploadMiddleware, updateProfile as express.RequestHandler)
